    ...
    <>
      ...
      <Layout>
        ...
        <section>
          ...
          <FeatureSection
            image="/comcast_open_source_profile.svg"
            alt="Comcast Open Source Site Details"
            color="mercury"
          >
            <div className="bug">
              <h3>GitHub Repo</h3>
              <p>
                <a href={comcastGithubIo.url}>{comcastGithubIo.name}</a>
              </p>
            </div>
            <div className="bug">
            ...
            <div className="bug">
              <h3>
                <strong>{comcastGithubIo.mentionableUsers.totalCount}</strong>
              </h3>
              <p>users involved</p>
            </div>
            <div className="bug">
              <h3>
                <strong>{comcastGithubIo.commit.history.totalCount}</strong>
              </h3>
              <p>commits</p>
            </div>
            <div className="bug">
              <h3>
                Aug 23 <strong>2017</strong>
              </h3>
              <p>initial launch</p>
            </div>
            <div className="bug">
            ...
            <div className="bug">
              <h3>Tags</h3>
              <p>
                {comcastGithubIo.repositoryTopics.edges.map(
                  (topic, index) =>
                    `${topic.node.topic.name}${
                      index < comcastGithubIo.repositoryTopics.edges.length - 1
                        ? ", "
                        : ""
                    }`
                )}
        ...
        <section>
          ...
          <Cta
            type="calendar"
            color="purple"
            label={eventsSection.cta.label}
            url={eventsSection.cta.url}
          />
        </section>
        <section>
          ...
          <Cta
            type="messages"
            color="blue"
            label={blogSection.cta.label}
            url={blogSection.cta.url}
          />
        </section>
      </Layout>
    </>
