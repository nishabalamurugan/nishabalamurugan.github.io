...
const Projects = ({
  ...
  const filteredList = allRepos
    .filter((item) => item && item.node.name !== ".github")
    .filter((data) => {
      ...
      <Layout>
        ...
        <section className="repo">
          ...
          <div>
            ...
            >
              <NumberFigure
                color="orange"
                number={totalRepos}
                caption="Total Public Repos"
              />
              <NumberFigure
                color="blue"
                number={totalSourceRepos}
                caption="Total Source Repos"
              />
              <NumberFigure
                color="red"
                number={totalForkedRepos}
                caption="Total Forked Repos"
              />
              <NumberFigure
                color="green"
                number={totalMembers}
          ...
          <Cta
            type="atom"
            color="yellow"
            label="View All Comcast Repos on GitHub"
